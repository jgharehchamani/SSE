...
namespace sse {
    namespace sophos {
        ...
        k_prf_(derivation_master_key), inverse_tdp_(tdp_private_key), rsa_prg_(rsa_prg_key)
        {
        }
        ...
        UpdateRequest   SophosClient::update_request(const std::string &keyword, const std::array<uint8_t, kUpdateTokenSize> index)
        {
            UpdateRequest req;
